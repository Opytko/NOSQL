...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("pytkoostapevent")//namespace
                .setEventHubName("ostapeventhub")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://pytkoostapevent.servicebus.windows.net/;SharedAccessKeyName=ostappolicy;SharedAccessKey=Q4iNa0kjV9gitVH0BJdbAo36tgVATmcAAJEHQh6B0ug=;EntityPath=ostapeventhub")
                /*Primary key*/
                .setSasKey("Q4iNa0kjV9gitVH0BJdbAo36tgVATmcAAJEHQh6B0ug=");
